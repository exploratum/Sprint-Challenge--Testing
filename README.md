...
1. In Jest, what are the differences between `describe()` and `it()` globals, and what are good uses for them?
    ...
    'Describe' can be used to group several tests in one test suite
    'It' is a single test by itself

1. What is the point of `Test Driven Development`? What do you think about this approach?

    You do testing before you write the code of your application
    If you have enough time, yes will improve quality and avoid unintended consequences when you change your code in the future.
